...
import numpy as np
from .model import AutoencoderCNNModel as Model
from .loader import CNNDatum as Datum
...
class Solver(object):
    ...
    def load_model(self, iter_):
        f = osp.join(self.save_path, 'CFD_CNN_{}iter.ckpt'.format(iter_))
    ...
    def test(self):
        ...
        with torch.no_grad():
            for i, (filename, dist_func, y_coordinate) in enumerate(tqdm(self.data_loader)):
                ...
                mse_pixel.append(datum.mse.cpu())
